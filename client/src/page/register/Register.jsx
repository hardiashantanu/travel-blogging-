  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <form className="p-8 bg-white rounded shadow-md" onSubmit={handleSubmit}>
        ...
        <button className="w-full p-3 text-xl text-white bg-blue-500 rounded hover:bg-blue-600" type="submit">Register</button>
      </form>
      <button className="btn p-3 text-xl mt-3">
        <Link className="" to="/login">LOGIN</Link>
      </button>
      {error && <span className="mt-6 text-xl text-red-500">Something went wrong</span>}
    </div>
  );
}